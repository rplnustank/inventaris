...
<head>
  ...
  <title>Admin LAB | Table Barang Masuk</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b>NUSANTARA</b></span>
    </a>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a href="<?=base_url('excel')?>" style="margin-bottom:10px;" type="button" class="btn btn-danger" name="laporan_data"><i class="fa fa-file-text" aria-hidden="true"></i> download excel</a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright @ RPL NUSANTARA&copy; <?=date('Y')?></strong>
