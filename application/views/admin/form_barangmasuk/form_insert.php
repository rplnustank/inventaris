...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-mini"><b>NUSAN</b>TARA</span>
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="id_transaksi" style="margin-left:220px;display:inline;">ID barang</label>
                  <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" readonly="readonly" value="LAB-<?=date("Ymd");?><?=random_string('numeric', 3);?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  ...
                  <input type="text" name="lokasi" style="margin-left:75px;width:20%;display:inline;" class="form-control" readonly="readonly" value="BANTEN">
                </div>
               
                <div class="form-group" style="display:inline-block;">
                  <label for="kode_barang" style="width:87%;margin-left: 12px;">Kode Barang / Barcode</label>
                  <input type="text" name="kode_barang" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_barang" readonly="readonly" placeholder="Kode Barang" value="<?=date("yymmdd");?><?=random_string('numeric', 3);?>">
                </div>
                <div class="form-group" style="display:inline-block;">
